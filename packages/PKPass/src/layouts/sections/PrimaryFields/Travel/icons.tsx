...
function FlightIcon(props: BoardingIconProps) {
	return (
		<svg
			id="flight"
...
function BoatIcon(props: BoardingIconProps) {
	return (
		<svg
			id="boat"
			x="0px"
...
function RailIcon(props: BoardingIconProps) {
	return (
		<svg
			id="rail"
			x="0px"
...
function BusIcon(props: BoardingIconProps) {
	return (
		<svg
			id="bus"
			x="0px"
...
function GenericIcon(props: BoardingIconProps) {
	return (
		<svg
			id="generic"
			x="0px"
