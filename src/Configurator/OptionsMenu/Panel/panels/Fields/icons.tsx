...
export const FieldsArrowIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const FieldsAddIcon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg viewBox="0 0 128 128" {...props} id="plus">
...
// dots by Andrejs Kirma from the Noun Project (edited)
// https://thenounproject.com/term/dots/2915594

export const MoreFieldsBelowIcon = (props: React.SVGProps<SVGSVGElement>) => (
	<svg viewBox="0 0 25 4" {...props}>
