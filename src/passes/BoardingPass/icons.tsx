...
const FlightIcon = (props: BoardingIconProps) =>
	<svg width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 73 73" style={{ fill: props.fill }}>
...
const BoatIcon = (props: BoardingIconProps) =>
	<svg x="0px" y="0px" width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 50 50">
		<g>
...
const RailIcon = (props: BoardingIconProps) =>
	<svg x="0px" y="0px" width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 36 36">
...
export function PKTransitIcon(icon: PKTransitType) {
	return (props: BoardingIconProps) => {
		const WrappedIcon = PKTransitIconsMap[icon];

		return <WrappedIcon {...props} width={25} height={25} />
	}
}
