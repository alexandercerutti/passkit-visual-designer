...
export const FlightIcon = (props: BoardingIconProps) =>
...
export const BoatIcon = (props: BoardingIconProps) =>
...
export const RailIcon = (props: BoardingIconProps) =>
...
export const BusIcon = (props: BoardingIconProps) =>
	<svg x="0px" y="0px" width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 50 50">
...
export const GenericIcon = (props: BoardingIconProps) =>
	<svg x="0px" y="0px" width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 50 50">
