...
const FlightIcon = (props: BoardingIconProps) =>
	<svg width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 73 73" style={{ fill: props.fill }} className={props.className || ""}>
...
const BoatIcon = (props: BoardingIconProps) =>
	<svg x="0px" y="0px" width={`${props.width}px`} height={`${props.height}px`} viewBox="0 0 50 50" className={props.className || ""}>
		<g>
